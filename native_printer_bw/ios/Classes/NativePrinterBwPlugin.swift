...
public class NativePrinterBwPlugin: NSObject, FlutterPlugin {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "native_printer_bw", binaryMessenger: registrar.messenger())
    let instance = NativePrinterBwPlugin()
